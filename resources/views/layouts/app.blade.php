...
{{--         
         ...
         --}}
          <div class="right-links float-right mr-4">
            <a href="#" class="home"><i class="mdi mdi-home-variant"></i></a>
            
            <div class="d-inline dropdown rounded-0 mx-3">
              <a class="dropdown-toggle" id="tools" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><i class="mdi mdi-settings-box" aria-hidden="true"></i></a>
            ...
            <div class="d-inline dropdown mr-3">
              <a class="dropdown-toggle" id="notifications" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><span>10</span><i class="mdi mdi-rss-box"></i></a>
            ...
            <div class="d-inline dropdown mr-3">
              <a class="dropdown-toggle" id="messages" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><i class="mdi mdi-facebook-messenger"></i></a>
              ...
              <div class="row">
                <div class="col-md-3 px-0">
                  <a class="btn rounded-0 border-0 d-flex w-100 justify-content-between p-3 pl-5" data-toggle="collapse" href="#menuOne" aria-expanded="false" aria-controls="collapseExample" id="more">Slider Revolution
                    <i class="mdi mdi-monitor-multiple" aria-hidden="true"></i>
        ...
        <div data-component="sidebar">
          ...
          <ul class="list-group flex-column d-inline-block first-menu">
            <li class="list-group-item pl-3 py-2">
              <a href="#"><i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Reporting</span></i></a>
            ...
            <li class="list-group-item pl-3 py-2">
              <a href="#"><i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Content</span></i></a>
              <ul class="list-group flex-column d-inline-block submenu">
                <li class="list-group-item pl-4">
            ...
            <li class="list-group-item pl-3 py-2">
              <a href="#">
                <i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Engagement</span></i>
              </a>
              <ul class="list-group flex-column d-inline-block submenu">
            ...
            <li class="list-group-item pl-3 py-2">
              <a href="#"><i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Image Center</span></i></a>
            ...
            <li class="list-group-item pl-3 py-2">
              <a href="#"><i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Settings</span></i></a>
              <ul class="list-group flex-column d-inline-block submenu">
                <li class="list-group-item pl-4">
            ...
            <li class="list-group-item pl-3 py-2">
              <a href="#"><i class="mdi mdi-monitor-multiple" aria-hidden="true"><span class="ml-2 align-middle">Support</span></i></a>
              <ul class="list-group flex-column d-inline-block submenu">
                <li class="list-group-item pl-4">
